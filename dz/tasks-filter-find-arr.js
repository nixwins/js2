...
const students = [
  ...
  { name: "Елена", grades: [5, 5, 5, 5, 5], age: 19, group: "Б" },
...
const otlichnik = students.find((item) => {
  const isOtlichnick = item.grades.every((grade) => grade === 5); // true //false

  return isOtlichnick;
});
console.log("otlichnik", otlichnik);
